      ...
      <div className="mt-[20px]">
        <Container  className=' '>
          <Row className='flex-col'>
            <div className="mb-7">
              <h2 className='font-[700] text-[30px] md:text-[20px] uppercase text-[#272727] space-[5px]'>{ml(option?.servis_title_1_az, option?.servis_title_1_ru, option?.servis_title_1_en)}</h2>
            </div>
            {
            ...
            <div className="mt-7 mb-3">
              <h2 className='font-[700] text-[30px] md:text-[20px] uppercase text-[#272727] space-[5px]'>{ml(option?.servis_title_2_az, option?.servis_title_2_ru, option?.servis_title_2_en)}</h2>
            </div>
            <Row className='mt-3'>
              {
                service2 && service2?.map((cur, i) => (
                  <Col lg={3} md={6} xs={6} key={i} className='mb-5 '>
